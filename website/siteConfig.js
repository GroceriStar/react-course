...
const siteConfig = {
  title: 'React course' /* title for your website */,
  tagline: 'React course',
  ...
  headerLinks: [
     {doc: 'summary', label: 'Summary'},
       {href : 'https://github.com/GroceriStar/react-course/', label: 'GitHub'},
  ...
  // template. For example, if you need your repo's URL...
     repoUrl: 'https://github.com/GroceriStar/react-course',
};
